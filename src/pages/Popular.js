...
const Popular = ({selectedMonth, setMonth, setCategory, selectedCategory}) => {
  ...
  useEffect(() => {
    ...
    return (
        <div>
           <Navbar selectedMonth={selectedMonth} setMonth = {setMonth} setCategory={setCategory} selectedCategory={selectedCategory}/>
            <GameList>
